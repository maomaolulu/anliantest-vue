...
export default {
            ...
            handler(val) {
                ...
                if (val) {
                    ...
                    val.forEach((item) => {
                        ...
                        item['url']=import.meta.env.VITE_APIIMG_URL + item.preUrl
                  
                    });
                    // this.fileList.push({
                    //         name: item.fileName,
                    //         url: import.meta.env.VITE_APIIMG_URL + item.preUrl,
                    //         id: item.id,
                    //     });
                    this.fileList = this.arrSome(val, 'id');
                    this.imgsData = val;
                } else {
                    this.fileList = [];
                    this.imgsData = [];
    ...
    methods: {
        ...
        handleUploadSuccess(res, file) {
            if (res.code === 200) {
                this.fileList.push({
                    name: res.data.url[0].fileName,
                    url: import.meta.env.VITE_APIIMG_URL + res.data.url[0].preUrl,
                    id: res.data.url[0].id,
                });
