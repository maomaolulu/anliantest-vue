    ...
    <div class="myPage">
        <div class="myPageTop45">
            <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
                ...
                <el-select v-model="queryParams.status" class="selfSerchInput140 mm10" placeholder="任务状态" clearable>
                    <el-option
                        v-for="(dict, k) in store.dictMap['sys_job_status']"
                        :key="k"
                        :label="dict.dictLabel"
                        :value="k"
                    />
        ...
        <div class="myCenter135">
            <el-table v-loading="loading" :data="jobList" height="100%" @selection-change="handleSelectionChange">
                    ...
                    <template #default="scope">
                        <div class="flex_c_c">
                            <el-link
                                ...
                                >修改</el-link
                            >
                            <div class="el-divider el-divider-vertical" v-hasPermi="['monitor:job:remove']"></div>
                            <el-link
                                type="primary"
                                class="fontSize12"
                                v-hasPermi="['monitor:job:remove']"
                            ...
                            <el-dropdown
                                ...
                                v-hasPermi="['monitor:job:changeStatus', 'monitor:job:query']"
                            >
                                <el-link type="primary" class="fontSize12" :underline="false">更多</el-link>
                                <template #dropdown>
                                    <el-dropdown-menu>
                    ...
                    <el-col :span="12">
                        <el-form-item label="状态">
                            <el-radio-group v-model="form.status">
                                <el-radio v-for="(dict, k) in store.dictMap['sys_job_status']" :key="k" :label="k">{{
                                    dict.dictLabel
                                }}</el-radio>
                            </el-radio-group>
                        </el-form-item>
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="任务分组：">{{
                            store.dictMap['sys_job_group'][form.jobGroup].dictLabel
                        }}</el-form-item>
...
export default {
    ...
    methods: {
        ...
        handleStatusChange(row) {
            ...
            this.$confirm('确认要"' + text + '""' + row.jobName + '"任务吗？')
                .then(function () {
        ...
        /* 立即执行一次 */
        handleRun(row) {
            this.$confirm('确认要立即执行一次"' + row.jobName + '"任务吗？')
                .then(function () {
