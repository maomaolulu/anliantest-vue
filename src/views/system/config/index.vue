<template>
    <div class="myPage">
        <div class="myPageTop45">
            <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
                ...
                <el-select
                    ...
                    clearable
                >
                    <el-option v-for="(dict, k) in sysConfigStatus" :key="k" :label="dict" :value="k" />
                </el-select>
                <el-date-picker
                    v-model="dateRange"
        ...
        <div class="myCenter135">
            <el-table v-loading="loading" :data="configList" height="100%" @selection-change="handleSelectionChange" size="small">
                ...
                <el-table-column label="系统内置" align="center" prop="configType">
                    <template #default="scope">
                        <el-tag :type="scope.row.configType == 'Y' ? 'success' : 'danger'">{{
                            sysConfigStatus[scope.row.configType]
                        }}</el-tag>
                    </template>
                </el-table-column>
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="系统内置" prop="configType">
                    <el-radio-group v-model="form.configType">
                        <el-radio v-for="(dict, key) in sysConfigStatus" :key="key" :label="key">{{ dict }}</el-radio>
                    </el-radio-group>
                </el-form-item>
