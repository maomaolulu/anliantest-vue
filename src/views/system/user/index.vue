                ...
                <el-table v-loading="loading" :data="userList" height="100%" @selection-change="handleSelectionChange">
                    ...
                    >
                        <template #default="scope">
                            <span>{{ sys_user_sex[scope.row.sex].label }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                        label="所属公司"
                    ...
                    >
                    <template #default="scope">
                        {{ scope.row.companyKey?store.dictMap['sys_ehs_company'][scope.row.companyKey].dictLabel:'-' }}
                    </template>
                </el-table-column>
                    <el-table-column
                        label="邮箱"
                    ...
                    <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width">
                        <template #default="scope">
                            <template v-if="scope.row.userId !== 1">
                                ...
                                >
                                    <el-button size="small" class="noMar padding2-5" type="text" icon="More"
                                        >更多</el-button
                                    >
                                    <template #dropdown>
                                        <el-dropdown-menu>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="工号" prop="jobNum">
                            <el-input v-model="form.jobNum" placeholder="请输入" maxlength="30" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="状态">
                            <el-radio-group v-model="form.status">
                                <el-radio v-for="dict in sys_normal_disable" :key="dict.value" :label="String(dict.value)">{{
                                    dict.label
                                }}</el-radio>
                            </el-radio-group>
                        </el-form-item>
